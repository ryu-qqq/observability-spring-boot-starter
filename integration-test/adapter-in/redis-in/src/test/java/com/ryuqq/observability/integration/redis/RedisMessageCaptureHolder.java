...
/**
 * 비동기 Redis 메시지 수신 검증을 위한 캡처 유틸리티.
 *
 * <p>리스너가 메시지를 처리할 때 컨텍스트 정보를 캡처하고,
 * 테스트에서 검증할 수 있도록 합니다.</p>
 */
public class RedisMessageCaptureHolder {
    ...
    private final AtomicReference<String> capturedChannel = new AtomicReference<>();
    private CountDownLatch latch = new CountDownLatch(1);

    public void capture(String traceId, String userId, String tenantId,
                       String organizationId, String payload, String channel) {
